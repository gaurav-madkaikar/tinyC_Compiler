...
%union{
    int intval;         // Integer constant
    char charval;       // Character constant
    idStr idl;          // Identifier
    float floatval;     // Floating constant
    string *strval;     // Enumeration constant
    decStr decl;        // declarators
    arglistStr argsl;   // Store arguments list
    int instr;          
    expresn expon;      // expression
    list *nextlist;     
}
...
%token ARROW INCREMENT DECREMENT LEFT_SHIFT RIGHT_SHIFT LESS_EQUALS GREATER_EQUALS EQUALS NOT_EQUALS
%token AND OR ELLIPSIS MULT_ASSIGN DIV_ASSIGN MOD_ASSIGN ADD_ASSIGN SUB_ASSIGN
